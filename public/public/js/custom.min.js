...
function featuredmenus()
      ...
      if(jQuery('.featured-menus').length > 0) {
          jQuery('.featured-menus').owlCarousel({
            ...
            autoplay: false,
            dots: false,
            navText: ['<i class="fa fa-caret-left" style="margin-top: 25%;margin-left:-10%;"></i>', '<i class="fa fa-caret-right" style="margin-top: 25%;margin-left:10%;"></i>'],
            responsive:{
              0:{
                items:1
              },
...
jQuery('.pro-down').on('click',function(){
	jQuery('.arrow-down').toggleClass('active');
});


jQuery('.open-menu').on('click',function(){
	$('.deznav').addClass('active');
	$('.nav-header').addClass('active');
	$('.content-body').addClass('active');
});

jQuery('.close-btn-sidebar').on('click',function(){
	$('.deznav').removeClass('active');
	$('.nav-header').removeClass('active');
	$('.content-body').removeClass('active');
	console.log('working or not');
});

jQuery('.filter-link').on('click',function(){
	$('.fliter-div-uerlist').toggleClass('active');
});
