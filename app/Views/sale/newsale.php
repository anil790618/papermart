...
<div class="modal fade " id="orderspecificationModal" tabindex="-1" aria-labelledby="orderspecificationModalLabel" aria-hidden="true">
 <div class="modal-dialog modal-lg">
     <div class="modal-content" style="overflow-x:auto">
         ...
         <form method="post" id="send_orderspecification_form"  enctype="multipart/form-data">
...
<div class="modal fade " id="generateVehicleRequestModalWastPaper" tabindex="-1" aria-labelledby="generateVehicleRequestModalLabel" aria-hidden="true">
 <div class="modal-dialog modal-lg">
     <div class="modal-content">
         <div class="modal-header">
         ...
         <form method="post" id="generate_vehiclerequest_form">
             <input type="hidden" name="orderid" id="order_id1" class="form-control">
             <input type="hidden" name="vs" id="vs" class="form-control" value='1'>
             <div class="modal-body  p-3">
                 <div class="   col-6">
                 ...
                 <div class="mt-2 col-12">
                     <div class="form-row transportresponse"  >
                         <div class="mb-0 col-6">
                             <label> Vehicle No.</label><span class="text-danger">*</span>
                             <input type="text" class="form-control  form-control-sm " name="vehicledetail" id="vehicledetail1" tag="1" autocomplete="off" placeholder="Enter vehicle number">
                             <!-- <div class="suggestionAra vehicle"></div> -->
                             <input type="hidden" name="vehicle_id" id="vehicle_id">
                             <span class="text-danger size-7 e_vehicledetail"></span>
                         </div>
                     ...
                     <div class="col-6">
                         <label>Dispatch Image</label><span class="text-danger">*</span>
                         <input type="file" class="form-control  form-control-sm " name="dispatchimage" id="dispatchimage" tag="1"  autocomplete="off" placeholder="" >
                     </div>
                     <!-- <div class="col-6">
                         <label>Packing Slip Excel</label><span class="text-danger">*</span>
                         <a style="margin-left:100px" href="${base_url}public/packingslip.xlsx" downloadable><small class="text-primary ">Download excel</small></a>
                         <input type="file" class="form-control  form-control-sm " name="packingslipimage" id="packingslipimage" tag="1"  required >
                     </div> -->
                     <div class="col-6">
                         <label>Invoice Image</label><span class="text-danger">*</span>
                         <input type="file" class="form-control  form-control-sm " name="invoiceimage" id="invoiceimage" tag="1"  required >
                     </div>
                     <div class="col-6"><label>E-Invoice Image</label><span class="text-danger">*</span><input type="file" class="form-control  form-control-sm " name="einvoiceimage" id="einvoiceimage" tag="1"  required >
                 </div>
                 <div class="col-6"><label>eWay Image</label>
                 <input type="file" class="form-control  form-control-sm " name="ebayimage" id="ebayimage" tag="1"  autocomplete="off" placeholder="" >
             </div>
             <div class="col-6"><label>GR Image</label><input type="file" class="form-control  form-control-sm " name="girimage" id="girimage" tag="1"  autocomplete="off" placeholder="" ></div><div class="col-6"> <label>Invoice no </label><input type="text" class="form-control  form-control-sm " name="invoiceno" id="invoiceno"  autocomplete="off" placeholder="Enter Invoice number " > </div><div class="col-6"> <label>Invoice Date </label><input type="date" class="form-control  form-control-sm " name="invoicedate" id="invoicedate"  autocomplete="off" placeholder=" " > </div> <div class="col-6"> <label>eWay Bill Number </label><input type="text" class="form-control  form-control-sm " name="ewaybillno" id="ewaybillno"  autocomplete="off" placeholder=" " > </div>
             <!-- <div class="col-6"> <label>Freight Rate </label><input type="text" class="form-control  form-control-sm " name="freight_rate" id="freight_rate"  autocomplete="off" placeholder=" " > </div> -->
             <div class="col-6"><label>IRN no. </label><input type="text" class="form-control  form-control-sm " name="gst" id="gst"  autocomplete="off" placeholder=" " > </div><div class="col-6"><label>ACK no. </label><input type="text" class="form-control  form-control-sm " name="cgst" id="cgst"  autocomplete="off" placeholder=" " > </div><div class="col-6"><label>Insurance No. </label><input type="text" class="form-control  form-control-sm " name="insurance_no" id="insurance_no"  autocomplete="off" placeholder=" " > </div><div class="col-6"><label>Quantity </label><input type="text" class="form-control  form-control-sm " name="totalquatity" id="totalquatity"  autocomplete="off" placeholder=" " > </div><div class="col-6"> <input type="hidden" class="form-control  form-control-sm " name="discount" id="discount" value="0" > 
                     </div>
                 </div>
