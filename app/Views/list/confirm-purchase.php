...
<div class="card-header p-0">
    <h4 class="card-title m-2">Confirm Requirement Response </h4>
    <div class="pull-right float-end ">
        <ul class="nav nav_filter ">
            <li class="nav-item text-end">
               <a href="javascript:void(0)" class="btn btn-primary mb-2 viewList" tag="<?=$listedproduct['id']?>" >Back</a>
          ...
          <?php 
                ...
                <div class="form-group mb-0  col-md-3">
                    ...
                    <select  class="form-control" id="delivery_type" name="delivery_type" > 
                        <option value="0" <?php if ( $response['delivery_type'] =='0'){ echo 'selected';} else { echo 'disabled'; }  ?> >Self Pick Up</option>
                        <option value="0" >Doorstep Delivery</option>
                ...
                <div class="form-group mb-0  col-md-3">
                    ...
                    <input type="text" class="form-control" name="ddays" id="ddays" placeholder="Delivery days" value="<?= $listedproduct['delivery_days']?>" >
                 ...
                 <div class="form-group mb-0  col-md-3">
                   ...
                   <select  class="form-control" name="pterms" tag="1" id="pterms" >
                        ...
                        <option value="1" <?php if($listedproduct['payment_terms'] == '1'){ echo 'selected'; } else { echo 'disabled'; } ?> >Same Day</option>
                        <option value="2" <?php if($listedproduct['payment_terms'] == '2'){ echo 'selected'; } else { echo 'disabled'; } ?> >30 Days</option>
                ...
                <?php
                    ...
                    ?>
                            ...
                            <td>
                             ...
                             <td>
                                        <input type="text" style="height:36px" class=" form-control rate" name="rate[]" tag="<?=$i?>"  value="<?=$value['frate']?>" required readonly>
