        ...
        <div class="card  mb-0">
            <div class="card-body size-4">
              ...
              <?php 
                    ...
                    <div class="form-group col-md-3 pquality" style="display:none;">
                    ...
                    <div class="form-group mb-0  col-md-3" <?php if($dashboard_type == 2){ echo ' style="display:none"'; } ?> >
