            ...
            <div class="card ">
                    ...
                    <div class="tabel-link-btn">
                        <ul class="nav nav_filter active-status">
                            ...
                            <li class="nav-item text-end mr-3">
                                <a class="approvecounteroffer" href="javascript:void(0)"
                                    tag="<?=$response['id'];?>"><span class="badge light badge-success badge-text-size "
                                        title="Approve Counter Offer Request"><i class="fa fa-check"></i></span></a>

                            </li>
                            <li class="nav-item text-end mr-3">
                                <a class="cancelcounteroffer" href="javascript:void(0)"
                                    tag="<?=$response['id'];?>"><span class="badge light badge-danger badge-text-size "
                                        title="Reject Counter offer Request"><i class="fa fa-times"></i></span></a>

                            </li>

                            <?php  } } else if($response['counterstatus'] == 1 ) { ?><a href="javascript:void(0)"><span
                                    class="badge light badge-success badge-text-size">Accepted</span></a>
                            <?php } else if($response['counterstatus'] == 2 ) {  ?>
                            <a href="javascript:void(0)"><span
                                    class="badge light badge-danger badge-text-size">Rejected</span></a>
                            <?php }else if($response['counterstatus'] == 0){
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        <div id="table">
                            <table id="producttype_tbale" class="table table-responsive-md tabledata table-bordered">
                                <thead>
                                    <th>S.No</th>
                                    <th>Validity</th>
                                    <th>Delivery Days</th>
                                ...
                                ?> 
                                    <tr id="row<?=$value['id']?>" class=" bg-success" tag="<?=$value['id']?>">
                                        ...
                                        <td> <a href="javascript:void(0)"><span
                                                    class="badge light badge-danger badge-text-size">
                                                    <?php
                                        ...
                                        <!-- <td id="desc<?=$value['id']?>" class='colspanresp'>
                                            <?=$value['description'];?>
                                        </td> -->
                                        ...
                                        if($timing < 0) { 
                                            ?>
                                            <a href="javascript:void(0)" id="<?=$value['id']?>" data-bs-toggle="modal"
                                                data-bs-target="#updateValidityModal"> <span
                                                    class="badge light badge-primary badge-text-size fs-14">Update
                                                    Validity </i></span></a>
                                            <?php
                                         }
                                        ...
                                        if ($listspecification[0]['sub_category']==28 || $listspecification[0]['sub_category']==29) { 
                                            if ($listedproduct['admin_approved']==1) {
                                               ?>
                                            <a class="apprived_wastepapersale" <?=$atr?> href="javascript:void(0)" tag="<?=$value['id'];?>" title=" Confirm Response "><span
                                                    class="badge light badge-success badge-text-size fs-14"><i
                                                        class="fa fa-check"></i></span>
                                            </a>
                                            <?php
                                            }else{
                                                ?>
                                            <a class=" " <?=$atr?> href="javascript:void(0)" tag="<?=$value['id'];?>" title=" Confirm Response "><span
                                                    class="badge light badge-success badge-text-size fs-14">Response
                                                    Confirmed</span>
                                            </a>
                                            <?php
                                            }
                                        ...
                                        if ($user_type !=2) {
                                            ?>
                                            <a class="counteroffer" href="javascript:void(0)" tag="<?=$value['id'];?>"
                                                counter="<?=$value['counterid'];?>" title=" Post Counter Offer1  "><span
                                                    class="badge light badge-warning badge-text-size fs-14"><i
                                                        class="fa fa-money"></i></span></a>
                                            <a class="<?=$cl?>" <?=$atr?> href="javascript:void(0)" tag="<?=$value['id'];?>" title=" Confirm Response "><span
                                                    class="badge light badge-success badge-text-size fs-14"><i
                                                        class="fa fa-check"></i></span>
                                            </a>
                                            <a class="disapproveList" href="javascript:void(0)"
                                                tag="<?=$value['id'];?>"><span
                                                    class="badge light badge-danger badge-text-size"
                                                    title=" Reject Response "><i class="fa fa-times"></i></span></a>
                                            <?php
                                        }
                                        if ($user_type ==2){
                                            ?>
                                            <a class="productSize_buyer" href="javascript:void(0)"
                                                tag="<?=$value['list_id']?>" userid="<?=$value['added_by']?>"
                                                title=" Upload size  "><span
                                                    class="badge light badge-secondary badge-text-size fs-14">Upload
                                                    Size List</i></span></a>
                                            <?php
                                            ...
                                            <?php
                                                if ($value['response_counter_status']=='1') {
                                                    ...
                                                    ?>
                                            <a class="confrimcounterresponse_r" href="javascript:void(0)"
                                                tag="<?=$value['id'];?>" title=" Confirm Counter Response "><span
                                                    class="badge light badge-success badge-text-size fs-14"><i
                                    ...
                                    ?>
                                            ...
                                            <a href="javascript:void(0)"><span
                                                    class="badge light badge-success badge-text-size">Approved</span></a>
                                            <?php } else if($value['status']==2){ ?>
                                            <a href="javascript:void(0)"><span
                                                    class="badge light badge-danger badge-text-size">Rejected</span></a>
                                            <?php } else if($value['status']==3){ ?> <a href="javascript:void(0)"><span
                                                    class="badge light badge-danger badge-text-size">Cancelled</span></a>
                                            <?php } } ?>
                                        </td>
                                    </tr>
                                    <tr class="">
                                        ...
                                        <div id="table">
                                         <table id="producttype_tbale" class="table table-responsive-md tabledata table-bordered">
                                        <tbody class="specification<?=$value['id']?> " tag="<?=$value['id']?>"
                                            style="display:contents">
                                            <script>getResponseSpecification(<?php echo $value['id'];?>);</script>
                                        </tbody>
                    ...
                    <div class="table-responsive">
                        <table class="table shadow-hover">
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <p class="text-black mb-1 font-w600 text-center">Category<br>Name</p>
                                    </td>
                                    <td>
                                        <span class="fs-14">
                                            <?=$listedproduct['catname']??''?>
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <p class="text-black mb-1 font-w600 text-center">Delivery <br> days</p>
                                    </td>
                                    <td>
                                        <span class="fs-14">
                                            <?=$listedproduct['delivery_days']??''?>
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <p class="text-black mb-1 font-w600 text-center">Delivery <br> Type</p>
                                    </td>
                                    <td>
                                        <span class="fs-14">
                                            <?php if($listedproduct['delivery_type']==0){ echo 'Self Pick Up'; } else { echo 'Doorstep Delivery';}?>
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <p class="text-black mb-1 font-w600 text-center">Place of <br> Delivery</p>
                                    </td>
                                    <td>
                                        <?php
                                                    if ($user_type != 3) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="fs-14">
                                            <?=$listedproduct['validity']?>
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <p class="text-black mb-1 font-w600 text-center">Rates Offered <br> Type</p>
                                    </td>
                                    <td>
                                        <span class="fs-14">
                                            <?=$listedproduct['rates_offered']?>
                                        </span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <p class="text-black mb-1 font-w600">Payment <br> Terms</p>
                                    </td>
                                    <td>
                                        <span class="fs-14">
            ...
            <div class="table-div ">
                <div class="tabel-body-div ">
                    <div class="table-responsive ">
                        ...
                        <div id="table">
                            <table id="producttype_tbale"
                                class="table table-responsive-md tabledata size-6 table table-bordered">
                                <tr>
                                    <th>S.No. </th>
                                    <?php
                                    ...
                                    <?php 
                                                        ...
                                                        foreach($array as $data) //loop over values
                                                        {
                                                            ...
                                                            if($data == 'quantity_type'){ 
                                                                ...
                                                                ?>
                                <tr>
                                    <table id="wastepapertable" class='table-bordered table' style="">
                                        <tr> </tr>
                                        <tr>
                                            <th></th>
                                            <th>ON-Report</th>
                                        ...
                                        <form method="post" id="update_wastpaper_price">
                                            <input type="hidden" class="tableinput" <?=$attr?> value="
                                            <?=$listspecification_waste["id"]??""?>" name="id">
                                            <input type="hidden" class="tableinput" <?=$attr?> value="1"
                                            name="rowcount[]">
                                            <input type="hidden" class="tableinput" <?=$attr?> value="
                                            <?=$listedproduct['catname']??""?>" name="category">
                                            <input type="hidden" class="tableinput" <?=$attr?> value="
                                            <?=$listedproduct['delivery_days']??''?>" name="delivery_days">
                                            <input type="hidden" class="tableinput" <?=$attr?> value="
                                            <?=$listedproduct['delivery_type']??""?>" name="delivery_type">
                                            <input type="hidden" class="tableinput" <?=$attr?> value="
                                            <?=$listedproduct['product_location']??""?>" name="product_location">
                                            <input type="hidden" class="tableinput" <?=$attr?> value="
                                            <?=$listedproduct['validity']??""?>" name="validity">
                                            <input type="hidden" class="tableinput" <?=$attr?> value="
                                            <?=$listedproduct['rates_offered']??""?>" name="rates_offered">
                                            <input type="hidden" class="tableinput" <?=$attr?> value="
                                            <?=$listedproduct['payment_terms']??""?>" name="pterm">
                                            <input type="hidden" class="tableinput" <?=$attr?> value="
                                            <?=$sub_category??""?>" name="sub_category">
                                            <input type="hidden" class="tableinput" <?=$attr?> value="
                                            <?=$listspecification_waste["valid_from"]??""?>" name="valid_from">
                                            <input type="hidden" class="tableinput" <?=$attr?> value="
                                            <?=$truck_ratio??""?>" name="truck_ratio">
                                            <input type="hidden" class="tableinput" <?=$attr?> value="
                                            <?=$bundle_weight??""?>" name="bundle_weight">
                                            <?php
                                        ...
                                        ?>
                                            <tr>
                                                <th>Scan</th>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["w_scan_on"]??""?>" name="w_scan_on">
                                                </td>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["w_scan_non"]??""?>" name="w_scan_non">
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Colour</th>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["w_color_on"]??""?>" name="w_color_on">
                                                </td>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["w_color_non"]??""?>"
                                                    name="w_color_non">
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Copy</th>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["w_copy_on"]??""?>" name="w_copy_on">
                                                </td>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["w_copy_non"]??""?>" name="w_copy_non">
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Record</th>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["w_record_on"]??""?>"
                                                    name="w_record_on">
                                                </td>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["w_record_non"]??""?>"
                                                    name="w_record_non">
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Shorted Book</th>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["w_short_on"]??""?>" name="w_short_on">
                                                </td>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["w_short_non"]??""?>"
                                                    name="w_short_non">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["w_whitecutting_on"]??""?>"
                                                    name="w_whitecutting_on">
                                                </td>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["w_whitecutting_non"]??""?>"
                                                    name="w_whitecutting_non">
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>White Pepsi</th>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["w_pepsi_on"]??""?>" name="w_pepsi_on">
                                                </td>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["w_pepsi_non"]??""?>"
                                                    name="w_pepsi_non">
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>White Board</th>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["w_board_on"]??""?>" name="w_board_on">
                                                </td>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["w_board_non"]??""?>"
                                                    name="w_board_non">
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Old Book</th>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["w_book_on"]??""?>" name="w_book_on">
                                                </td>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["w_book_non"]??""?>" name="w_book_non">
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Rulled Cutting</th>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["w_rulled_on"]??""?>"
                                                    name="w_rulled_on">
                                                </td>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["w_rulled_non"]??""?>"
                                                    name="w_rulled_non">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["w_tick_on"]??""?>" name="w_tick_on">
                                                </td>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["w_tick_non"]??""?>" name="w_tick_non">
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["k_corr1_on"]??""?>" name="k_corr1_on">
                                                </td>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["k_corr1_non"]??""?>"
                                                    name="k_corr1_non">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["k_corr2_on"]??""?>" name="k_corr2_on">
                                                </td>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["k_corr2_non"]??""?>"
                                                    name="k_corr2_non">
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Dye Cutting</th>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["k_dye_on"]??""?>" name="k_dye_on">
                                                </td>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["k_dye_non"]??""?>" name="k_dye_non">
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Grey Board</th>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["k_grey_on"]??""?>" name="k_grey_on">
                                                </td>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["k_grey_non"]??""?>" name="k_grey_non">
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Duplex</th>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["k_duplex_on"]??""?>"
                                                    name="k_duplex_on">
                                                </td>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["k_duplex_non"]??""?>"
                                                    name="k_duplex_non">
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Mill Board</th>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["k_mill_on"]??""?>" name="k_mill_on">
                                                </td>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["k_mill_non"]??""?>" name="k_mill_non">
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Core Pipe</th>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["k_core_on"]??""?>" name="k_core_on">
                                                </td>
                                                <td><input type="text" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["k_core_non"]??""?>" name="k_core_non">
                                                </td>
                                            </tr>
                                            <?php
                                                }
                                            ...
                                            <tr>
                                                <th></th>
                                                <td><input type="datetime-local" class="tableinput" <?=$attr?> value="
                                                    <?=$listspecification_waste["valid_from"]??""?>" name="valid from">
                                                </td>
                                                <td><button type="submit" class="btn btn-primary" <?=$attr?>>Change
                                                        Price</button></td>
                                            </tr>
                                            <?php
                                                }
        ...
        <div class=" col-lg-12 mt-5 ">
            <div class=" ">
                <div class="card-body card">
                    <div class="table-responsive">
                        <table class="table shadow-hover table-bordered">
                            <tbody>
                                <tr>
                                <td>
            ...
            <div class="card ml-2">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        <div id="table">
                            <table id="producttype_tbale" class="table table-bordered text-center tabledata size-6">
                                <thead>
                                    <th>S.No</th>
...
<div class="modal fade " id="counterofferModal" tabindex="-1" aria-labelledby="counterofferModalLabel"
    aria-hidden="true">
...
<div class="modal fade " id="viewProductDescriptionModal" tabindex="-1" aria-labelledby="counterofferModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form method="post" id="add_orderspecification_form">
                <input type="hidden" name="listproduct_id" id="listproduct_id" value="<?=$listedproduct['id']?>"
                    class="form-control">
