                                        ...
                                        <div id="table">
                                            <table id="producttype_tbale" class="table table-responsive-md tabledata size-6">
                                                <tr>
                                                    ...
                                                    {
                                                        if($value == 'rate' and $listedproduct['catname'] != 'Waste Paper'){
                                                            echo '<th  class="labeltext">Rate offer</th> ';
                                                        }
                                                        else{
                                                ...
                                                ?>
                                                        ...
                                                        {  
                                                            if($data == 'quantity_type'){ if($value[$data]==1){ echo '<td>Godown</td>'; } 
                                                             ...
                                                             else if( $data == 'rate' ){  if( $listedproduct['catname'] == 'Waste Paper' ){echo '<td> '.$value['rate'].' </td>';} else{
