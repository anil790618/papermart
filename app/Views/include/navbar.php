...
<div class="header">
 ...
 <li class="nav-item pro-down dropdown  header-profile">
                        ...
                        <ul class="navbar-nav header-right">
                            <li class="notification-icon dropdown">
                                <div class="notibell dropdown-toggle" type="button" id="notification-aria" data-bs-toggle="dropdown" aria-expanded="false">
                                    <div class="noto-signal"><span class="noto-signal-in"><?php if ($notification) {echo count($notification); }else{echo 0;}?></span></div>
                                    ...
                                    <?php
                                        ...
                                        {   $i=1;
                                            ...
                                            { 
                                                ...
                                                ?>
                                                <a href="javascript:void(0)" onclick="mynotificationfun('<?=$value['url']?>','<?=$value['added_by']?>')">
                        ...
                        <?php
                            if ($user_type != 0) {
                            echo'<div id="google_element"></div>';
                            }
                        ?>
