...
<div class="container-fluid">
 ...
 <style>
   ...
   <table class="table-bordered" style="border: 2px solid black; margin:10px; width:95%">
     ...
     <tr>
       <td colspan="11" style="border: 2px solid black; text-align: center;font-size:14px">
        <b style="font-size:20px"> <?=$zeto['company_name']?></b> <br>Invoice Location : <?=$zeto['address']?>, <?=$zeto['phone_number']?> 
      </td> 
 
     </tr>
     <tr>
         <td colspan="5" style=" border: 2px solid black; padding:10px; ">
                 <h6 style="font-size:18px" > Invoice No.  <b > :  9988775544</b></h6>
         ...
         <h6 style="font-size:18px" >Sales Through    <b>  : ABC ZYC</b></h6>
                ...
                <h6 style="font-size:18px" >Driver No      <b> : <?=$rate['driver_phone_number']?></b></h6>
                 ...
                 <h6 style="font-size:18px" > E-Way & Date  <b>:</b> </h6> -->
        </td>
     </tr>
     <tr>
      ...
      <td colspan="4"  style=" border: 2px solid black; padding-left:10px; ">
            ...
            <h6 style="font-size:18px">Payment Terms : </h6>
       </td>
       <td colspan="3"  style=" border: 2px solid black; padding-left:10px; ">
        ...
        <td colspan="4" style="border: 2px solid black; padding-left:10px; ">
             <!-- <h6 style="font-size:18px" >Dated</h6>
             <h6 style="font-size:18px" ><b> <?= $rate['added_date']?></b></h6> -->
             <h6 style="font-size:18px" >Transport    <b>  : TRUCK</b></h6>
                <h6 style="font-size:18px" >Vehicle No    <b>  : <?=$rate['vehicle_no']?></b></h6>
                <h6 style="font-size:18px" >Driver Name    <b> : <?=$rate['driver_name']?></b></h6>
                <h6 style="font-size:18px" >Driver No      <b> : <?=$rate['driver_phone_number']?></b></h6>
      ...
      <tr>
         <!-- <td colspan="11" style=" border: 2px solid black; padding-left:10px; ">
                 ...
                 <h6 style="font-size:18px" >Driver Name <b> : <?=$rate['driver_name']?></b></h6>
                 <h6 style="font-size:18px" >Driver No <b> : <?=$rate['driver_phone_number']?></b></h6>
                  <h6 style="font-size:18px" > GR  No & Date  </h6>
         </td> -->
     </tr>
     ...
     <?php
       ...
       <th style="font-size:18px; border: 2px solid black; padding-top:10px; padding-bottom: 10px; text-align:center;"> <?php
    $cid=$rate['category'];
    ...
    ?></th>
       ...
       <th style="font-size:18px; border: 2px solid black; padding-top:10px; padding-bottom: 10px; text-align:center"><?=$value['discount']?></th>
       <th style="font-size:18px; border: 2px solid black; padding-top:10px; padding-bottom: 10px; text-align:right;padding-right:15px"><?=$value['total_price']?></th>
     </tr>
         ...
         <tr  style="border: 2px solid black;">
            ...
            <tr  style="border: 2px solid black;">
              ...
              <td style="border: 2px solid black; font-size:18px;  padding-top:5px; padding-left:5px; padding-bottom: 5px; padding-right:15px;  text-align: right; ">
              <?php
              $p = $value['total_price'];
              $rg = ($p*6)/100;
              echo $rg;
        ...
        $totalprice = $tc+$fr+$ins+$rg+$rc;
            ?>
             <td style="border: 2px solid black; font-size:18px;  padding-top:5px; padding-bottom: 5px; padding-right:15px;  " colspan="10"> </td>
             <td style="border: 2px solid black; font-size:18px;  padding-top:5px; padding-bottom: 5px; padding-right:15px;  text-align: right; ">Rs. <?= $totalprice?></td>
           </tr>
